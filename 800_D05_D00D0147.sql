...
--end 9/5
 		<dataset name="dsCreateCol" queryText="EXEC Z_Q00713_D30P0707  value[''vDivisionID''], value[''vchkPeriod''], value[''vPeriodFr''], value[''vPeriodTo''], value[''vchkRDVoucherDate''], value[''vRDVoucherDateFrom''], value[''vRDVoucherDateTo''],0,value[''vVoucherNo''],'''','''',value[''vStatusSO''] " />
		<dataset name="dsGridData"  queryText="EXEC Z_Q00713_D30P0707  value[''vDivisionID''], value[''vchkPeriod''], value[''vPeriodFr''], value[''vPeriodTo''], value[''vchkRDVoucherDate''], value[''vRDVoucherDateFrom''], value[''vRDVoucherDateTo''],1,value[''vVoucherNo''],'''','''',value[''vStatusSO''] " />
...
--9/5
        ...
        <RadioButton Content="NgàyUUUUUU" x:Name="chkRDVoucherDate" HorizontalAlignment="Left" Margin="0,10,0,0" Grid.Row="2" Grid.Column="0" VerticalAlignment="Top" Height="22" Width="Auto" />
		...
		<!--Begin don han-->
		<Label x:Name="lblVoucherNo" Content="Số chứng từ thay thế thành Ngày giao hàng" HorizontalAlignment="Left" Margin="0,10,0,0" VerticalAlignment="Top" Width="100" Grid.Column="5" Grid.Row="1" />
