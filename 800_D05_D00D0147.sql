...
<!-- 9/5 -->
		<dataset name="StatusSO"	queryText="EXEC D05P0007 ''Status_D05F1621'' ,value[''vDivisionID''], value[''pUserID''], value[''pLanguage''], value[''pCodeTable''], '''', 4" />

<!-- 9/5 -->
 		<dataset name="dsCreateCol" queryText="EXEC Z_Q00713_D05P0707  value[''vDivisionID''], value[''vchkPeriod''], value[''vPeriodFr''], value[''vPeriodTo''], value[''vchkRDVoucherDate''], value[''vRDVoucherDateFrom''], value[''vRDVoucherDateTo''],0,value[''vVoucherNo''],'''','''',value[''vStatusSO''] " />
		<dataset name="dsGridData"  queryText="EXEC Z_Q00713_D05P0707  value[''vDivisionID''], value[''vchkPeriod''], value[''vPeriodFr''], value[''vPeriodTo''], value[''vchkRDVoucherDate''], value[''vRDVoucherDateFrom''], value[''vRDVoucherDateTo''],1,value[''vVoucherNo''],'''','''',value[''vStatusSO''] " />
...
<!-- 9/5  -->
		<!--Begin Trang thai-->
		<Label x:Name="lblStatusSO" Content="Trạng thái đơn hàng" HorizontalAlignment="Left" Margin="0,10,0,0" VerticalAlignment="Top" Height="20" Width="Auto" Grid.Column="5" Grid.Row="0"/>
        <dxg:LookUpEdit x:Name="tdbcStatusSO" Grid.Row="0" Grid.Column="6" HorizontalAlignment="Left" Margin="0,10,0,0" VerticalAlignment="Top" Width="120" Height="22" DisplayMember="IDName" ValueMember="IDKey" AutoPopulateColumns="False" PopupWidth="250" ImmediatePopup="True"  />
        <!--End Trang thai-->
		...
		<!--Visibility="{Binding IsChecked, ElementName=optReportDate}"-->

        <RadioButton Content="Ngàyy" x:Name="chkRDVoucherDate" HorizontalAlignment="Left" Margin="0,10,0,0" Grid.Row="2" Grid.Column="0" VerticalAlignment="Top" Height="22" Width="Auto" />
        <dxe:DateEdit x:Name="txbRDVoucherDateFrom" Grid.Row="2" Grid.Column="1" HorizontalAlignment="Left" Margin="0,10,0,0" VerticalAlignment="Top" Width="120" Height="22" Mask="dd/MM/yyyy" MaskType="DateTime" DisplayFormatString="dd/MM/yyyy" NullValue="01/01/1900"  DateTime="{Binding To, Mode=TwoWay, RelativeSource={RelativeSource AncestorType={x:Type Window}}, UpdateSourceTrigger=PropertyChanged}" IsEnabled="True"/>
