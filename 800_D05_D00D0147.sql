...
<form version="4.0.0" formID="ZQ00713D05F0707" type="Inquiry" caption="*Thống kê đơn hàng bán">
	...
	<datasets>
		...
		<dataset name="dsCreateCol" queryText="EXEC Z_Q00713_D30P0706  value[''vDivisionID''], value[''vchkPeriod''], value[''vPeriodFr''], value[''vPeriodTo''], value[''vchkRDVoucherDate''], value[''vRDVoucherDateFrom''], value[''vRDVoucherDateTo''],0,value[''vVoucherNo''] "  />
		<dataset name="dsGridData"  queryText="EXEC Z_Q00713_D30P0706  value[''vDivisionID''], value[''vchkPeriod''], value[''vPeriodFr''], value[''vPeriodTo''], value[''vchkRDVoucherDate''], value[''vRDVoucherDateFrom''], value[''vRDVoucherDateTo''],1,value[''vVoucherNo''] " />
